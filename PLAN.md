...
| ~~F3~~ | ~~The readiness gate passed a motion-blurred capture.~~ **Addressed 2026-08-17 by removing auto-capture.** Sample index 18 was unreadable and the shutter fired on it by itself. The gate still arms the shutter — the button stays disabled below a GOOD band — but it no longer presses it. The failure was the app choosing a frame, not the gate blocking too little. | `sample_data/roi/SAMPLE_20260816_200322_734.jpg` | Closed |
