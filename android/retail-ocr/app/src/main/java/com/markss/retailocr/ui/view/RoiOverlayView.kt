package com.markss.retailocr.ui.view
 ...
 * preview resolution. [roiFraction] is what [com.markss.retailocr.ui.ScanActivity]
...
class RoiOverlayView @JvmOverloads constructor(
     ...
     */
    fun setBand(band: com.markss.retailocr.ocr.ReadinessTracker.Band) {
        val next = ContextCompat.getColor(
            context,
            when (band) {
                com.markss.retailocr.ocr.ReadinessTracker.Band.GOOD -> R.color.roi_good
                com.markss.retailocr.ocr.ReadinessTracker.Band.FAIR -> R.color.roi_fair
                com.markss.retailocr.ocr.ReadinessTracker.Band.POOR -> R.color.roi_poor
            },
        )
